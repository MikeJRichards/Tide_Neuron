...
actor TideNeuronToken {
  ...
  let TDNToken : TokenArgs = {
    ...
    public query func icrc1_name(): async Text {
        return TDNToken.init.tokenDetails.name;
    };

    public query func icrc1_symbol(): async Text {
        return TDNToken.init.tokenDetails.symbol;
    };

    public query func icrc1_decimals(): async Nat8 {
        return TDNToken.init.tokenDetails.decimals;
    };
    ...
    public query func icrc1_transfer_fee(): async Balance {
        return TDNToken.init.tokenDetails.transfer_fee;
    };
...
//
    ...
    //        balances.put(owners[i], tokens[i]);
    //    };
    //};
};
